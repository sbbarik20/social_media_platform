    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mnub', models.CharField(blank=True, max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='users.user')),
                ('likers', models.ManyToManyField(blank=True, related_name='likes', to='users.user')),
                ('shares', models.ManyToManyField(blank=True, related_name='shares', to='users.user')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commenters', to='users.user')),
            ],
        ),
    ]
